...
public class Position {
	...
	public static ImmutableList<Position> positionsInColumn(int column) {
		checkColumn(column);
		return IntStream.rangeClosed(1, 9)
				.mapToObj(row -> new Position(row, column))
				.collect(ImmutableList.toImmutableList());
	}
	...
	public static ImmutableList<Position> positionsInBox(int box) {
		...
		return ImmutableList.of(
				Position.of(firstRow, firstCol), Position.of(firstRow, firstCol + 1), Position.of(firstRow, firstCol + 2),
				Position.of(firstRow + 1, firstCol), Position.of(firstRow + 1, firstCol + 1), Position.of(firstRow + 1, firstCol + 2),
				Position.of(firstRow + 2, firstCol), Position.of(firstRow + 2, firstCol + 1), Position.of(firstRow + 2, firstCol + 2));
	}
